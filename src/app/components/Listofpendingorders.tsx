import { NotebookTabs, PrinterCheck, StepForward } from 'lucide-react'
import React from 'react'

function Listofpendingorders() {
  return (
    <div className='ml-6 pb-10'>
    <h1 className='font-bold text-3xl font-serif'>List of Pending Orders</h1>
    <table className='mt-6 border-collapse border-2 border-gray-500 w-[52rem] h-[6rem] overflow-scroll table-auto'>
      <thead className='h-12'>
          <tr className='bg-slate-300'>
              ...
              <th className='text-start border-2 border-gray-500 font-serif text-xl pl-2'>Send to Delivery</th>
      ...
      <tbody className=''>
          <tr >
              ...
              <td className='border-2 border-gray-500 w-32 pl-10 cursor-pointer'><StepForward /></td>
    ...
    <div className='mt-6 flex space-x-10 items-center'>
      <h1 className='font-serif text-2xl font-bold'>Total Pending Orders</h1>
...
export default Listofpendingorders
