...
function Listoforderbooker() {
  return (
    <div className='mt-8 ml-6 pb-12'>
    <h1 className='font-bold text-3xl font-serif'>List of Order Booker</h1>
    <table className='mt-6 border-collapse border-2 border-gray-500 w-[52rem] h-[6rem] overflow-scroll table-auto'>
      <thead className='h-12'>
          <tr className='bg-slate-300'>
              <th className='text-start border-2 border-gray-500 font-serif text-xl pl-2'>Order Booker</th>
...
export default Listoforderbooker
