...
function Listofsupplier() {
  return (
    <div className='mt-16 ml-14 pb-20'>
      <h1 className='font-bold text-3xl font-serif'>List of Supplier</h1>
      <table className='mt-6 border-collapse border-2 border-gray-500 w-[45rem] h-[6rem] overflow-scroll table-auto'>
        <thead className='h-12'>
            <tr className='bg-slate-300'>
                <th className='text-start border-2 border-gray-500 font-serif text-xl pl-2'>Supplier</th>
        ...
        <tbody className=''>
            <tr >
                <td className='font-serif text-lg border-2 border-gray-500 pl-2'>Supplier 1</td>
                <td className=' text-lg border-2 border-gray-500 pl-2'>50</td>
      ...
      <div className='mt-6 flex space-x-10 items-center'>
        <h1 className='font-serif text-2xl font-bold'>Grand Balance</h1>
        <p className='text-2xl  font-bold bg-green-300 rounded-lg px-10 py-2'>50</p>
      </div>
    </div>
  )
}
