import { NotebookTabs, PrinterCheck } from 'lucide-react'
import React from 'react'

function Listofpartialpaidorders() {
  return (
    ...
    <div className='mt-6 flex space-x-10 items-center'>
      <h1 className='font-serif text-2xl font-bold'>Total Partial Paid Orders</h1>
...
export default Listofpartialpaidorders
